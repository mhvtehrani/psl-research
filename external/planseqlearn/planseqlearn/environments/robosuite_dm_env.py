...
import robosuite.environments.manipulation.lift
import robosuite.environments.manipulation.door
import robosuite.environments.manipulation.pick_place
import robosuite.environments.manipulation.nut_assembly
...
class Robosuite_Wrapper(dm_env.Environment):
    def __init__(
        ...
        if env_name == "NutAssembly":
            ...
            reward_scale = 1.0
        has_renderer = extra_kwargs.pop("has_renderer", False)
        has_offscreen_renderer = extra_kwargs.pop("has_offscreen_renderer", True)
        use_camera_obs = extra_kwargs.pop("use_camera_obs", True)
        self._env = robosuite_make(
            robots="Panda",
            reward_shaping=True,
            control_freq=20,
            ignore_done=True,
